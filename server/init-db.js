// Remove the sequelize import that's causing issues
...
async function main() {
		...
		const sampleProducts = [
			{
				name: "Mogi POS",
				slug: "mogi-pos",
				description: "Sistem point of sale terintegrasi untuk manajemen ritel modern",
				longDescription:
					"Mogi POS adalah solusi komprehensif untuk manajemen ritel yang dirancang untuk membantu bisnis Anda berkembang. Dengan fitur canggih dan antarmuka yang mudah digunakan, Mogi POS memungkinkan Anda untuk mengelola inventaris, penjualan, dan pelanggan dengan efisien.",
				category: "pos",
				...
				pricing: JSON.stringify({
					basic: {
						price: "Rp 299.000",
						period: "/bulan",
						features: ["Hingga 5 pengguna", "Manajemen inventaris dasar", "Laporan penjualan harian"],
					},
					pro: {
						price: "Rp 799.000",
						period: "/bulan",
					...
					enterprise: {
						price: "Custom",
						period: "",
						features: ["Pengguna tak terbatas", "Fitur kustom", "Dukungan dedicated"],
					},
				}),
				isActive: true,
				sortOrder: 1,
			},
			{
				...
				longDescription:
					"MogiPay menyederhanakan proses pembayaran untuk bisnis Anda dengan menyediakan integrasi yang mulus dengan berbagai gateway pembayaran. Terima pembayaran dari berbagai sumber dengan keamanan tingkat enterprise.",
				category: "pay",
				features: JSON.stringify([
					"Integrasi 10+ payment gateway",
					"Keamanan PCI-DSS compliant",
					"Manajemen refund dan chargeback",
					"API yang mudah digunakan",
				]),
				benefits: JSON.stringify([
					"Tingkatkan konversi pembayaran",
				...
				pricing: JSON.stringify({
					basic: {
						price: "Rp 199.000",
						period: "/bulan",
						features: ["Hingga 3 payment gateway", "Transaksi hingga 100 juta/bulan", "Email support"],
					},
					pro: {
						price: "Rp 499.000",
						period: "/bulan",
						features: [
							"Hingga 10 payment gateway",
							"Transaksi hingga 500 juta/bulan",
	...
	if (blogCount === 0) {
		...
		const sampleBlogs = [
			{
				title: "5 Cara Meningkatkan Efisiensi Bisnis dengan Teknologi",
				slug: "5-cara-meningkatkan-efisiensi-bisnis-dengan-teknologi",
				body: "<p>Dalam era digital saat ini, teknologi memainkan peran penting dalam meningkatkan efisiensi bisnis. Berikut adalah 5 cara utama untuk memanfaatkan teknologi demi pertumbuhan bisnis Anda:</p><p>1. Otomatisasi proses rutin<br>2. Gunakan sistem manajemen yang terintegrasi<br>3. Implementasikan analitik data<br>4. Manfaatkan cloud computing<br>5. Terapkan solusi mobile untuk tim lapangan</p>",
				image: null,
				isShow: true,
				createdBy: "Admin",
				source: "MogiApp Team",
			...
			{
				title: "Tren Terbaru dalam Sistem POS Modern",
				slug: "tren-terbaru-dalam-sistem-pos-modern",
				body: "<p>Industri point of sale (POS) terus berkembang dengan inovasi baru setiap tahunnya. Artikel ini membahas tren terbaru yang sedang berkembang dalam sistem POS modern dan bagaimana bisnis dapat memanfaatkannya.</p><p>Dari integrasi AI hingga solusi berbasis cloud, sistem POS modern kini menawarkan lebih dari sekedar pencatatan transaksi.</p>",
				image: null,
				isShow: true,
				createdBy: "Admin",
				source: "MogiApp Team",
...
// Remove the old sequelize code that's causing issues
// Connect to MySQL
// sequelize
// 	.authenticate()
// 	.then(() => {
...
// 					longDescription:
// 						"Mogi POS adalah solusi point of sale komprehensif yang dirancang untuk membantu bisnis ritel Anda mengelola penjualan, inventaris, dan pelanggan dengan efisien. Dengan antarmuka yang intuitif dan fitur yang kuat, Mogi POS memungkinkan Anda untuk fokus pada pertumbuhan bisnis Anda.",
// 					category: "pos",
// 					features: [
// 						"Manajemen inventaris real-time",
// 						"Integrasi pembayaran multi-channel",
...
// 					longDescription:
// 						"MogiPay adalah platform pembayaran digital yang memungkinkan bisnis Anda menerima pembayaran dari berbagai channel dengan aman dan efisien. Terintegrasi langsung dengan Mogi POS dan sistem lainnya.",
// 					category: "pay",
// 					features: [
// 						"Pembayaran QR Code",
// 						"Integrasi e-wallet",
...
// 					longDescription:
// 						"Mogi Ops membantu Anda mengelola seluruh operasional bisnis dalam satu platform terpadu. Dari manajemen tugas harian hingga pelaporan kinerja, Mogi Ops memberikan solusi komprehensif untuk meningkatkan produktivitas tim Anda.",
// 					category: "ops",
// 					features: [
...
// 							price: "Custom",
// 							period: "",
// 							features: ["Fitur kustom", "Dukungan dedicated", "Penyimpanan tak terbatas", "API kustom"],
// 						},
// 					},
// 					isActive: true,
// 					sortOrder: 3,
...
// 					longDescription:
// 						"Mogi Fleet memungkinkan Anda untuk mengelola armada kendaraan secara efisien dengan pelacakan real-time, manajemen pengemudi, dan optimasi rute. Solusi ini membantu perusahaan logistik dan transportasi mengurangi biaya operasional sambil meningkatkan layanan pelanggan.",
// 					category: "fleet",
// 					features: [
...
// 							price: "Rp 499.000",
// 							period: "/bulan",
// 							features: ["Hingga 5 kendaraan", "Pelacakan dasar", "Laporan mingguan", "Notifikasi dasar"],
// 						},
// 						pro: {
// 							price: "Rp 999.000",
// 							period: "/bulan",
...
// 					longDescription:
// 						"MogiSign menyederhanakan proses penandatanganan dokumen dengan solusi tanda tangan digital yang aman dan mudah digunakan. Kirim, tandatangani, dan simpan dokumen secara digital dalam hitungan menit, sesuai dengan regulasi eIDAS dan UU ITE Indonesia.",
// 					category: "sign",
// 					features: [
...
// 					longDescription:
// 						"Mogi Library membantu institusi pendidikan dan perusahaan mengelola koleksi digital mereka dengan mudah. Dari kataloging hingga sirkulasi, sistem ini menyediakan solusi komprehensif untuk manajemen perpustakaan modern.",
// 					category: "library",
// 					features: [
...
// 							price: "Rp 249.000",
// 							period: "/bulan",
// 							features: ["Hingga 5.000 item", "Manajemen dasar", "Laporan bulanan", "2 pengguna admin"],
// 						},
// 						pro: {
// 							price: "Rp 499.000",
// 							period: "/bulan",
...
// 					longDescription:
// 						"Mogi Kampuz menyediakan solusi terpadu untuk manajemen institusi pendidikan, mencakup akademik, keuangan, sarana prasarana, dan kemahasiswaan. Platform ini membantu perguruan tinggi mengelola operasional mereka dengan lebih efisien dan efektif.",
// 					category: "kampuz",
// 					features: [
// 						"Manajemen akademik",
// 						"Sistem keuangan",
...
// 					longDescription:
// 						"Mogi Dynamics membantu bisnis memahami, mengelola, dan mengembangkan hubungan dengan pelanggan mereka. Dengan fitur CRM lengkap, otomatisasi pemasaran, dan analitik pelanggan, platform ini meningkatkan loyalitas pelanggan dan penjualan.",
// 					category: "dynamics",
// 					features: [
// 						"Manajemen kontak",
// 						"Pipeline penjualan",
