...
const Hero = () => {
	...
	return (
		<section
			id="hero"
			className="pt-20 pb-16 min-h-screen flex items-center bg-gradient-to-br from-background to-primary/5 relative"
		>
				...
				<div className="grid lg:grid-cols-2 items-center gap-16">
					...
					<div className="text-center lg:text-left">
						...
						<h1 className="text-4xl md:text-5xl font-bold text-foreground mb-8 leading-tight">
							Platform Terpadu <span className="text-primary block">Solusi Bisnis</span> Terdepan
						</h1>

						<p className="text-lg text-muted-foreground mb-12 max-w-xl mx-auto lg:mx-0">
							MogiApp menghadirkan platform terintegrasi untuk Point of Sale, manajemen operasional,
							tracking armada, dan digital signature.
						...
						<div className="space-y-4">
							...
							<div className="flex flex-wrap justify-center lg:justify-start gap-3">
								{platforms.map((platform, index) => (
									<div
										key={index}
										className="flex items-center gap-2 text-sm font-medium text-foreground px-3 py-2 rounded-full border border-border"
									>
